...
export const TeamScore: React.FC<TeamScoreProps> = ({
  ...
  return (
    <GlassCard 
      ...
      className={`p-6 ${isLeading ? 'ring-2 ring-yellow-400/50' : ''}`}
      glow={isLeading}
    >
      {/* Leading indicator */}
      {isLeading && (
        <motion.div
          className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-yellow-400 text-black px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1"
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-xs text-white/50 mt-1">HAPPINESS POINTS</p>
      </div>
